...
const translations = {
  delete: new TextBundle().add('en', 'Delete').add('nl', 'Verwijder').add('es', 'Eliminar').add('lt', 'Ištrinti').add('ro', 'Ștergeți'),
  undo: new TextBundle().add('en', 'Undo').add('nl', 'Herstel').add('es', 'Deshacer').add('lt', 'Atšaukti').add('ro', 'Anulați')
}
