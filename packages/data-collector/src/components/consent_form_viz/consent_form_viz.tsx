...
const defaultDonateQuestionLabel = new TextBundle()
  ...
  .add('lt', 'Ar norite pasidalinti aukščiau pateiktais duomenimis?')
  .add('ro', 'Doriți să împărtășiți datele de mai sus?')
...
const defaultDonateButtonLabel = new TextBundle()
  ...
  .add('es', 'Sí, compartir para investigación')
  .add('lt', 'Taip, dalintis tyrimų tikslais')
  .add('ro', 'Da, împărtășiți pentru cercetare')
...
const defaultDescription = new TextBundle()
  ...
  .add('ro', 'Determinați dacă doriți să împărtășiți datele de mai jos. Verificați cu atenție datele și ajustați dacă este necesar. Cu contribuția dvs., ajutați cercetarea descrisă anterior. Mulțumim anticipat.')
